...
function title() {
	...
	console.log(color(`\n${themeemoji} YT CHANNEL: @tutorialgame6819`,'magenta'))
console.log(color(`${themeemoji} GITHUB: @tutorialgame6819 `,'magenta'))
console.log(color(`${themeemoji} WA NUMBER: ${owner}`,'magenta'))
console.log(color(`${themeemoji} CREDIT: ${wm}\n`,'magenta'))
}

async function XeonBotIncBot() {
    	const { state, saveCreds } = await useMultiFileAuthState('session_rafli')
